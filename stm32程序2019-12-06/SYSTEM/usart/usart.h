...
#define USART6_REC_LEN  			1000  	//定义最大接收字节数 200
#define UART5_REC_LEN  			1000  	//定义最大接收字节数 200
#define UART4_REC_LEN  			1000  	//定义最大接收字节数 200

#define EN_USART1_RX 			1		//使能（1）/禁止（0）串口1接收
#define EN_USART2_RX 			1		//使能（1）/禁止（0）串口1接收
#define EN_USART3_RX 			1		//使能（1）/禁止（0）串口3接收
#define EN_UART4_RX       1		//使能（1）/禁止（0）串口3接收
#define EN_UART5_RX       1		//使能（1）/禁止（0）串口3接收
